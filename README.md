...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6xjvng8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6xjvng8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Chris-tian123/container-6xjvng8.git
cd container-6xjvng8
```
...
```
docker attach container-6xjvng8
```
